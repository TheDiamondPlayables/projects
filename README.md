...
- For Minecraft 26 and above (I like to call it 1.26), [because Mojang changed their numbering system](https://web.archive.org/web/20260131133943/https://www.minecraft.net/en-us/article/minecraft-new-version-numbering-system), I'm adding a dash and a number to indicate the game version this was made for.
  - So 26`a`0-x => Minecraft 26`.1`, and 26a`1`-x => Minecraft 26.1`.1`
  - Of course, this will only apply if a hotfix changes datapack contents.

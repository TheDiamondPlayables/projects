...
- For Minecraft 26 and above (I like to call it 1.26), [because Mojang changed their numbering system](https://web.archive.org/web/20260131133943/https://www.minecraft.net/en-us/article/minecraft-new-version-numbering-system), I'm adding an underscore that's meant to separate the Minecraft Release it's meant to be for and the version number.
  - So 26`a_`x => Minecraft 26`.1`, but 26`a1_`x => Minecraft 26`.1.1`  
